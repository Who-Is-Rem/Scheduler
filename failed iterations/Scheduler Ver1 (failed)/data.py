...
class PriceRange(Approx):
    ...
    def add(self, obj):
        ...
        return PriceRange(approxMin, approxMax)
...
class TimeRange(Approx):
    ...
    def add(self, obj):
        ...
        approxMin = self.min + obj.min
        approxMax = self.max + obj.max
        return TimeRange(approxMin, approxMax)
...
# temp = customDict()
# with open("/Users/al/Documents/csProjects/Nail Scheduler (py)/data.pickle", "wb") as path:
#     pickle.dump(temp, path)

# with open("/Users/al/Documents/csProjects/Nail Scheduler (py)/data.pickle", "rb+") as path:
#     dict = pickle.load(path)
#     dict.add(Service("Manicure", PriceRange("15"), TimeRange("30"), "M"), "Services")
#     dict.add(Service("Pedicure", PriceRange("26"), TimeRange("30"), "P"), "Services")
#     dict.add(Service("Color Gel Manicure", PriceRange("35"), TimeRange("60"), "CGM"), "Services")
